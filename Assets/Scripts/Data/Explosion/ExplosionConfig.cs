...
namespace Data.Explosion
{
    ...
    public class ExplosionConfig : ScriptableObject
    {
        ...
        // true = values will be cloned from parent projectile
        [Space]
        ...
        [BoxGroup("Explosion"), HideIf("cloneScale")] public float scale = 1f;
        [BoxGroup("Explosion"), HideIf("cloneDamage")] public float damage = 10f;
        [BoxGroup("Explosion")] public bool scaleAffectsRadius;
